...
func TestCreateEvent_InvalidInputs(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "invalid date format with wrong day",
			input: models.CreateEventInput{
				Name:        "Test",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result, err := resolver.Mutation().CreateEvent(ctx, tt.input)
...
func TestUpdateEvent(t *testing.T) {
	...
	input := models.UpdateEventInput{
		Name:        helpers.StringPtr("Updated Event"),
		Description: helpers.StringPtr("Updated Description"),
		Date:        helpers.StringPtr("2024-01-15T10:00:00Z"),
		Location:    helpers.StringPtr("Updated Location"),
		Organizer:   helpers.StringPtr("Updated Organizer"),
		Category:    helpers.StringPtr("Updated Category"),
		Tags:        []string{"updated", "event"},
		Capacity:    helpers.IntPtr(200),
	}
...
func TestGetEvents(t *testing.T) {
	...
	// Call the resolver
	result, err := resolver.Query().Events(ctx, helpers.IntPtr(1), helpers.IntPtr(10))
